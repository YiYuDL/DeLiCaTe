...
def main():
    ...
    assert args.max_seq_length <= Molbert_config.max_position_embeddings
    assert args.max_seq_length <= KDMolbert_config.max_position_embeddings
