...
def divide_parameters(named_parameters,lr=None):
    ...
    if len(decay_parameters_names)>0:
        ...
        if lr is not None:
            decay_group = {'params':decay_parameters,   'weight_decay_rate': delicate.kd.kd_config.args.weight_decay_rate, 'lr':lr}
        else:
            decay_group = {'params': decay_parameters, 'weight_decay_rate': delicate.kd.kd_config.args.weight_decay_rate}
