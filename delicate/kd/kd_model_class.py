...
from molbert.models.base import SuperPositionalBertModel
...
class MolBertconfig(BertConfig):
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(MolBertconfig, self).__init__(
...
class MolBertForDistill(BertPreTrainedModel):
    ...
    def forward(self, input_ids, token_type_ids, attention_mask, labels):
        ...
        loss_lm = None
        pre_lm = self.aa(sequence_output)
        logits = pre_lm
        ...
        return logits, pooled_output, hidden_states, attentions, loss_lm